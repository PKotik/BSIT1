...
/* Standard interface: RPC, ver. 1.0,
   GUID={0xD1D70F12,0x46E5,0x4FDD,{0x85,0x77,0x84,0x3F,0x6B,0xBD,0x41,0xA3}} */
...
static const RPC_SERVER_INTERFACE RPC___RpcServerInterface =
    ...
    {{0xD1D70F12,0x46E5,0x4FDD,{0x85,0x77,0x84,0x3F,0x6B,0xBD,0x41,0xA3}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
...
/* 252 */	NdrFcShort( 0x8 ),	/* X64 Stack size/offset = 8 */
/* 254 */	0x8,		/* FC_LONG */
			0x0,		/* 0 */
...
/* client_out */
    { 
    /* client_out */      /* procedure client_out */
...
/* login_client */
    { 
    /* login_client */      /* procedure login_client */
...
/* delete_file_on_server */
    { 
    /* delete_file_on_server */      /* procedure delete_file_on_server */
        (NDR64_UINT32) 786498 /* 0xc0042 */,    /* primitive handle */ /* IsIntrepreted, ClientMustSize, HasReturn */
...
/* send_to_server */
    { 
    /* send_to_server */      /* procedure send_to_server */
...
/* download_to_client */
    { 
    /* download_to_client */      /* procedure download_to_client */
        (NDR64_UINT32) 917570 /* 0xe0042 */,    /* primitive handle */ /* IsIntrepreted, ServerMustSize, ClientMustSize, HasReturn */
        (NDR64_UINT32) 48 /* 0x30 */ ,  /* Stack size */
        (NDR64_UINT32) 8 /* 0x8 */,
...
static const FormatInfoRef RPC_Ndr64ProcTable[] =
    {
    &__midl_frag2,
    &__midl_frag12,
    &__midl_frag20,
...
static const MIDL_STUB_DESC RPC_StubDesc = 
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& RPC_ServerInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const RPC_DISPATCH_FUNCTION RPC_NDR64__table[] =
    {
    NdrServerCallAll,
    NdrServerCallAll,
    NdrServerCallAll,
...
static const RPC_DISPATCH_TABLE RPC_NDR64__v1_0_DispatchTable = 
    {
    5,
    (RPC_DISPATCH_FUNCTION*)RPC_NDR64__table
    };

static const MIDL_SYNTAX_INFO RPC_SyntaxInfo [  2 ] = 
    {
    {
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&RPC_v1_0_DispatchTable,
    ...
    ,{
    {{0x71710533,0xbeba,0x4937,{0x83,0x19,0xb5,0xdb,0xef,0x9c,0xcc,0x36}},{1,0}},
    (RPC_DISPATCH_TABLE*)&RPC_NDR64__v1_0_DispatchTable,
    0 ,
    (unsigned short *) RPC_Ndr64ProcTable,
    0,
    0,
    0,
    0
...
static const MIDL_SERVER_INFO RPC_ServerInfo = 
    ...
    Source__MIDL_ProcFormatString.Format,
    (unsigned short *) RPC_FormatStringOffsetTable,
    0,
    (RPC_SYNTAX_IDENTIFIER*)&_NDR64_RpcTransferSyntax_1_0,
    2,
    (MIDL_SYNTAX_INFO*)RPC_SyntaxInfo
    };
#if _MSC_VER >= 1200
#pragma warning(pop)
#endif
