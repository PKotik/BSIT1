...
/* Standard interface: RPC, ver. 1.0,
 ...
 extern const MIDL_STUBLESS_PROXY_INFO RPC_ProxyInfo;
    ...
    /* [out] */ int *check_eof)
{
    ...
    _RetVal = NdrClientCall3(
                  ( PMIDL_STUBLESS_PROXY_INFO  )&RPC_ProxyInfo,
                  0,
                  0,
                  path,
                  buf,
...
static const MIDL_STUB_DESC RPC_StubDesc = 
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& RPC_ProxyInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const MIDL_STUBLESS_PROXY_INFO RPC_ProxyInfo =
    {
    &RPC_StubDesc,
    Source__MIDL_ProcFormatString.Format,
    RPC_FormatStringOffsetTable,
